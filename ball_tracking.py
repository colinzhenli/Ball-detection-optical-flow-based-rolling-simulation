...
while True:
    ...
    circles = cv2.HoughCircles(grayFrame, cv2.HOUGH_GRADIENT,1.7,100,param1=100,param2=30,minRadius=5,maxRadius=300)
    ...
    print([len(keypointBall), len(keypointFrame), len(goodMatches)]) #print the number of keypoints and matched keypoints in frame
